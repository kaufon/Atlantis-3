...
export class DeleteAccommodationUseCase{
  ...
  public async execute():Promise<void>{
    ...
    const accommodationId = await this.input.textInput("Insira o ID da acomodacao")
    const accomodationIndex = this.accommodations.findIndex((accomodation) => accomodation.id === accommodationId)
